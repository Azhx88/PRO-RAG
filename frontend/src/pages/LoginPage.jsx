...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', width: '800px', height: '800px', background: 'radial-gradient(circle, rgba(99,102,241,0.1) 0%, transparent 65%)', top: '-300px', left: '-300px', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', width: '600px', height: '600px', background: 'radial-gradient(circle, rgba(139,92,246,0.07) 0%, transparent 65%)', bottom: '-200px', right: '-200px', pointerEvents: 'none' }} />
      ...
      <div style={{ width: '100%', maxWidth: '400px', position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{
            ...
            justifyContent: 'center', boxShadow: '0 8px 32px rgba(99,102,241,0.35)', fontSize: '22px'
          }}>✦</div>
          <h1 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--text-primary)', letterSpacing: '-0.4px' }}>Welcome back</h1>
          <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginTop: '6px' }}>Sign in to your HybridRAG workspace</p>
        </div>
